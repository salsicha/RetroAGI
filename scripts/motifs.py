...
class Motifs():
    def __init__(self):
        ...
        self.p = stumpy.stump(self.c, self.m)

        all_gpu_devices = [device.id for device in cuda.list_devices()]
        p = stumpy.gpu_stump(self.c, self.m, device_id=all_gpu_devices)

        self.dists, self.inde = stumpy.motifs(self.c, self.p[:, 0], max_motifs=self.max_motifs)
    ...
    def find_motifs(self):
        ...
        for z in range(0, self.inde.shape[0]):
            ...
            matches = stumpy.match(self.c[start:stop], self.c, max_distance=2.0)
        ...
        # TODO: calculate frequency of motifs, return the most frequent ones
